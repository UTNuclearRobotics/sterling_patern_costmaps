...
alias run_nav2='ros2 launch utexas_panther bringup_launch.py namespace:=panther observation_topic:=ouster/scan observation_topic_type:=laserscan slam:=true use_sim_time:=true params_file:=/root/ros2_ws/src/sterling_sim_docker/sterling/config/nav2_params.yaml'
